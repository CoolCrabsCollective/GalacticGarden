...
namespace GameAssets {
    ...
    ASSET(wiz::TextureAsset, TEXTURE_INFOGRAPHIC, ("gfx/ui/infographicv2.png"))

    ASSET(wiz::TextureAsset, TEXTURE_LASER_SIMPLE, ("gfx/ui/upgrades/laser_simple.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_DOUBLE, ("gfx/ui/upgrades/laser_double.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_TRIANGLE, ("gfx/ui/upgrades/laser_triangle.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_FOUR_WAY, ("gfx/ui/upgrades/laser_quad.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_CRAZY, ("gfx/ui/upgrades/laser_crazy.png"))
    ASSET(wiz::TextureAsset, TEXTURE_NUKE_SIMPLE, ("gfx/ui/upgrades/nuke.png"))
    ASSET(wiz::TextureAsset, TEXTURE_FLAMETHROWER_SIMPLE, ("gfx/ui/upgrades/flame_thrower.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_NONE, ("gfx/ui/upgrades/boost_none.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_BASIC, ("gfx/ui/upgrades/boost_basic.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_ULTRA, ("gfx/ui/upgrades/boost_ultra.png"))
    ASSET(wiz::TextureAsset, TEXTURE_FLOWER_ICON, ("gfx/ui/upgrades/flower.png"))
    ASSET(wiz::TextureAsset, TEXTURE_CORN_ICON, ("gfx/ui/upgrades/corn.png"))

    ASSET(wiz::TextureAsset, TEXTURE_LOCKED, ("gfx/ui/upgrades/too_costly.png"))
    ASSET(wiz::TextureAsset, TEXTURE_SELECTED, ("gfx/ui/upgrades/select.png"))


    ASSET(wiz::TextureAsset, TEXTURE_LASER_SIMPLE_SMALL, ("gfx/ui/select/icon/laser_simple.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_DOUBLE_SMALL, ("gfx/ui/select/icon/laser_double.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_TRIANGLE_SMALL, ("gfx/ui/select/icon/laser_triangle.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_FOUR_WAY_SMALL, ("gfx/ui/select/icon/laser_quad.png"))
    ASSET(wiz::TextureAsset, TEXTURE_LASER_CRAZY_SMALL, ("gfx/ui/select/icon/laser_crazy.png"))
    ASSET(wiz::TextureAsset, TEXTURE_NUKE_SIMPLE_SMALL, ("gfx/ui/select/icon/nuke.png"))
    ASSET(wiz::TextureAsset, TEXTURE_FLAMETHROWER_SIMPLE_SMALL, ("gfx/ui/select/icon/flame_thrower.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_NONE_SMALL, ("gfx/ui/select/icon/boost_none.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_BASIC_SMALL, ("gfx/ui/select/icon/boost_basic.png"))
    ASSET(wiz::TextureAsset, TEXTURE_BOOST_ULTRA_SMALL, ("gfx/ui/select/icon/boost_ultra.png"))
    ASSET(wiz::TextureAsset, TEXTURE_FLOWER_ICON_SMALL, ("gfx/ui/select/icon/flower.png"))
    ASSET(wiz::TextureAsset, TEXTURE_CORN_ICON_SMALL, ("gfx/ui/select/icon/corn.png"))
}
